...
export async function buildApp(
  ...
  await fastify.register(fastifySwagger, {
    openapi: {
      info: {
        title: 'SMILES — structures in, structures out',
        description:
          'Read a structure written any way and write it every other way, one at a time or ten thousand at a time. The site does all of this in the browser; these routes are for scripts.',
        version: '1.0.0',
      },
      tags: [
        { name: 'convert', description: 'Structures in, structures out' },
