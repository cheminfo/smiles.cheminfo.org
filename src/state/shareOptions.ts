...
const CONVERTER: readonly HideKey[] = [
  'kinds',
  'editor',
  'formats',
  'examples',
];
const LISTS: readonly HideKey[] = ['load', 'options', 'export'];
...
const EXERCISES: readonly HideKey[] = [
  'sets',
  'hints',
  'check',
  'answers',
...
const SPECIFICATION: readonly HideKey[] = ['list'];
...
> = {
  ...
  tutorial: { title: 'Tutorial', parts: [], hasExercises: false },
  smiles: { title: 'SMILES sheet', parts: [], hasExercises: false },
  smarts: { title: 'SMARTS sheet', parts: [], hasExercises: false },
  specification: {
    title: 'Specification',
    parts: SPECIFICATION,
    hasExercises: false,
